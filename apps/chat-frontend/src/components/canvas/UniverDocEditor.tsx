    ...
    <div className="flex flex-col h-full bg-[#f8fafc] text-[#1e293b] select-none font-sans relative overflow-hidden">
      ...
      >
        ...
        <div
          ...
          className={`w-full max-w-4xl min-h-[600px] sm:min-h-[1000px] h-auto text-[#0f172a] border border-slate-200/90 ${
            showRuler ? 'sm:rounded-b-2xl sm:border-t-0 rounded-xl' : 'rounded-xl sm:rounded-2xl'
          } p-4 xs:p-8 sm:p-14 mb-20 shadow-md sm:shadow-[0_12px_40px_rgba(0,0,0,0.08)] relative transition-all !bg-white`}
        >
          {/* Subtle Top Header Tag */}
          <div className="flex items-center justify-between text-[9px] sm:text-[10px] text-[#94a3b8] border-b border-slate-100 pb-2.5 sm:pb-3 mb-4 sm:mb-6 select-none font-mono font-medium">
            <span>SOVEREIGN DOCUMENT STUDIO</span>
          ...
          <div
            ...
            onInput={handleInput}
            className="outline-none text-[13.5px] sm:text-[14.5px] leading-relaxed font-sans max-w-none focus:outline-none min-h-[500px] text-[#0f172a] bg-white"
          />

          {/* Bottom Sheet Footer Tag */}
          <div className="flex items-center justify-between text-[9px] sm:text-[10px] text-[#94a3b8] border-t border-slate-100 pt-4 sm:pt-6 mt-10 sm:mt-14 select-none font-mono">
            <span>Generated by Sovereign AI</span>
