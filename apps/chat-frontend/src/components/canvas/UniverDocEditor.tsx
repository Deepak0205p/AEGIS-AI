    ...
    <div className="flex flex-col h-full bg-[#f8fafc] text-[#1e293b] select-none font-sans relative overflow-hidden">
      ...
      >
        ...
        <motion.div
          ...
          className={`w-full max-w-4xl min-h-[450px] sm:min-h-[900px] h-auto text-[#0f172a] border border-slate-200/80 ${
            showRuler ? 'sm:rounded-b-2xl sm:border-t-0 rounded-xl' : 'rounded-xl sm:rounded-2xl'
          } p-3.5 xs:p-6 sm:p-14 mb-16 shadow-sm sm:shadow-[0_10px_35px_rgba(0,0,0,0.06)] relative transition-all bg-white`}
        >
          ...
          <div
            ...
            onInput={handleInput}
            className="outline-none text-[13.5px] sm:text-[14.5px] leading-relaxed font-sans max-w-none focus:outline-none min-h-[400px] text-[#0f172a]"
          />
